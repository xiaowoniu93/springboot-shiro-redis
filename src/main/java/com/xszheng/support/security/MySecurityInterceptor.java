...
public class MySecurityInterceptor extends AbstractSecurityInterceptor implements Filter {
	...
	public void invoke(FilterInvocation fi) throws IOException, ServletException {
		// fi里面有一个被拦截的url
        // 1、里面调用 CustomInvocationSecurityMetadataSourceService 的 getAttributes(Object object) 这个方法获取 url 对应的所有权限
        // 2、再调用 CustomAccessDecisionManager 的 decide 方法来校验用户的权限是否足够
